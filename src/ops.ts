// =============================================================================
// TENA: TypeScript Embedded NES Macro Assembler
//
...
export function ADC(a1?: any, a2?:any): OpDescription{
  ...
  if(arguments.length === 1 && (a1.type === "SymbolicLabel" || a1.type === "PositionalLabel")  ) 
 ...
 if(arguments.length === 2 && (a1.type === "SymbolicLabel" || a1.type === "PositionalLabel")    && a2 === "x") 
  ...
  if(arguments.length === 2 && (a1.type === "SymbolicLabel" || a1.type === "PositionalLabel")    && a2 === "y") 
  ...
  if(arguments.length === 2 && (a1.type === "SymbolicLabel" || a1.type === "PositionalLabel")   && a2 === "prex") 
  ...
  if(arguments.length === 2 && (a1.type === "SymbolicLabel" || a1.type === "PositionalLabel")   && a2 === "posty") 
...
export function BCC(value: Label): OpDescription;
...
export function BCS(value: Label): OpDescription;
...
export function BEQ(value: Label): OpDescription;
...
export function BMI(value: Label): OpDescription;
...
export function BNE(value: Label): OpDescription;
...
export function BPL(value: Label): OpDescription;
...
export function BVC(value: Label): OpDescription;
...
export function BVS(value: Label): OpDescription;
